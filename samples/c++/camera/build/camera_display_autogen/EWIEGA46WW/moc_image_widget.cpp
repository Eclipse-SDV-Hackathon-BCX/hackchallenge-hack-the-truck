...
QT_MOC_LITERAL(3, 22, 56), // "pb::SensorNearData::SurroundV..."
QT_MOC_LITERAL(4, 79, 5) // "image"

    },
    "ImageWidget\0setImage\0\0"
...
void ImageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setImage((*reinterpret_cast< const pb::SensorNearData::SurroundViewImage::SurroundViewImage(*)>(_a[1]))); break;
        default: ;
        }
    }
}
